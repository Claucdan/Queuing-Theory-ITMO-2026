...
Задачи:
Разработать математическую модель системы с приоритетами.
Провести расчеты основных характеристик системы для различных классов заявок.
Проанализировать влияние приоритетов на время ожидания и эффективность системы.
